        ...
        <div className='md:w-[80%] mx-auto flex flex-col gap-5'>
          {
            faqs.map((faq, index) => (
              ...
              >
                <div className={`flex justify-between items-center ${openIndex === index ? 'mb-3' : ''}`}>
                  <h3 className='text-lg md:text-xl font-bold text-subdued'>{faq.question}</h3>
                  {
                    openIndex === index ?  <Image 
                    src={"/faq-close.svg"} 
                    alt="toggle faq" 
                    width={20} 
                    height={22}
