  ...
  return (
    <section className='py-12 px-5 bg-[#F3F2FF]'>
      <div className='max-w-7xl mx-auto text-center'>
        <h2 className='md:w-[80%] mx-auto text-3xl md:text-4xl lg:text-5xl font-extrabold mb-3 text-subdued'>Your Money, Your life </h2>
        <p className='text-subdued w-[80%] md:w-1/2 mx-auto'>
        Our unique approach is built around four key principles inspired by the Self-Determination Theory (SDT) to help you take control of your money in a way that feels right for you.
        </p>
