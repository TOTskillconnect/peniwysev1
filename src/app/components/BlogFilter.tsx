  ...
  return (
    <section className='bg-primary'>
      <div className='max-w-7xl mx-auto px-5 pt-20 font-sans'>
        <h2 className='text-2xl md:text-5xl font-bold mb-5 text-center text-darkGrey font-montserrat'>The fates of great athletes</h2>
        <p className='text-center text-darkPurple md:w-1/2 mx-auto font-sans'>Chemistry has always been the Clippers&apos; issue. For starters, all their players have had some kind of injury this year, preventing the team from getting into a good rhythm and used to playing...</p>
            ...
            {filteredBlogs.length > 0 ? (
              filteredBlogs.map((blog) => (
                ...
                >
                  ...
                  <h3 className='text-2xl text-darkGrey font-bold font-montserrat'>{blog.title}</h3>
      ...
      <div className='max-w-7xl mx-auto px-5 py-20'>
        <h3 className='text-xl md:text-3xl font-bold mb-5 text-darkGrey'>Recent Posts</h3>
        ...
        <div className='flex flex-col gap-8 lg:w-2/3 mb-12'>
          {sortedBlogs.slice(0, visiblePosts).map((blog) => (
            <div 
              ...
              onClick={() => handleBlogClick(blog.slug)}
            >
              <Image src={blog.image} alt={blog.title} width={330} height={215} className='w-auto h-[215px] object-cover rounded-[10px]' />
