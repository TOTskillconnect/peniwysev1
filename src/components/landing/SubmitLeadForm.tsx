    ...
    <>
      <AppModal isOpen={isOpen} onClose={onClose}>
        <div className='flex flex-col items-center justify-center '>
          ...
          <div className='flex relative gap-2 border border-[#ECECEC] rounded-full mx-auto w-[85%] h-[60px] p-1 my-10 focus-within:border-lemon'>
            <input
              type='email'
              placeholder='Enter your email'
              className='w-[80%] p-2 rounded-full border border-transparent outline-none bg-transparent'
              value={email}
            ...
            <button
              ...
              className='bg-lemon text-darkPurple px-8 whitespace-nowrap rounded-full hover:transform hover:scale-[1.02] hover:shadow-sm transition-transform duration-300 ease-in-out'
            >
